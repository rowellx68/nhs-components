...
import { forwardRef, ForwardRefRenderFunction, ReactElement, FunctionComponent } from 'react';
...
export type PolymorphicFactory<TPayload extends PolymorphicFactoryPayload> = TPayload;
...
export function polymorphicFactory<TPayload extends PolymorphicFactoryPayload>(
  ...
  type ComponentProps<TComponent> = PolymorphicComponentProps<TComponent, TPayload['props']>;
