import{R as n}from"./index-Cs7sjTYM.js";import{c as E}from"./clsx-B-dksMZM.js";import{H as l}from"./Heading-CyaQd0b1.js";import"./_commonjsHelpers-BosuxZz1.js";import"./Base-fHV16vWU.js";import"./polymorphic-factory-23vJzvkj.js";const s=({size:e,className:a,...y})=>n.createElement("span",{className:E(`nhsuk-caption-${e}`,a),...y});s.displayName="HeadingCaption";s.__docgenInfo={description:"",methods:[],displayName:"HeadingCaption",props:{size:{required:!0,tsType:{name:"Extract",elements:[{name:"union",raw:"'s' | 'm' | 'l' | 'xl'",elements:[{name:"literal",value:"'s'"},{name:"literal",value:"'m'"},{name:"literal",value:"'l'"},{name:"literal",value:"'xl'"}]},{name:"union",raw:"'xl' | 'l' | 'm'",elements:[{name:"literal",value:"'xl'"},{name:"literal",value:"'l'"},{name:"literal",value:"'m'"}]}],raw:"Extract<Size, 'xl' | 'l' | 'm'>"},description:""}}};const w={title:"Styles/Typography/HeadingCaption",component:s,argTypes:{size:{control:{type:"select"},options:["xl","l","m"],table:{type:{summary:"union"}}}},parameters:{docs:{description:{component:"https://service-manual.nhs.uk/design-system/styles/typography#headings"}}}},t={args:{size:"xl"},render:e=>n.createElement(s,{...e},"nhsuk-caption-",e.size)},r={args:{size:"xl"},render:({size:e,...a})=>n.createElement(n.Fragment,null,n.createElement(s,{size:e,...a},"nhsuk-caption-",e),n.createElement(l,{size:e},"nhsuk-heading-",e))},i={args:{size:"xl"},render:({size:e,...a})=>n.createElement(n.Fragment,null,n.createElement(l,{variant:"caption-bottom",size:e},"nhsuk-heading-",e),n.createElement(s,{size:e,...a},"nhsuk-caption-",e))},o={args:{size:"xl"},render:({size:e,...a})=>n.createElement(l,{size:e},n.createElement(s,{size:e,...a},"nhsuk-caption-",e),"nhsuk-heading-",e)};var m,p,c;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: 'xl'
  },
