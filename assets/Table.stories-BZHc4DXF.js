import{r as t,R as l}from"./index-uCp2LrAq.js";import{f as M}from"./factory-Dl037jXY.js";import{c as m}from"./clsx-B-dksMZM.js";import{B as V}from"./Base-CQ_ipzy_.js";import"./_commonjsHelpers-BosuxZz1.js";const B=t.createContext({responsiveHeadings:[],registerHeadings:()=>{}}),I=t.createContext({head:!1}),S=()=>t.useContext(B),q=B.Provider,P=()=>t.useContext(I),A=I.Provider,e=M(({variant:a,className:n,...o},s)=>{const[c,r]=t.useState([]),u=t.useMemo(()=>({variant:a,responsiveHeadings:c,registerHeadings:r}),[a,c,r]);return l.createElement(q,{value:u},l.createElement("table",{className:m({"nhsuk-table":!a,[`nhsuk-table-${a}`]:a},n),...o,ref:s}))}),g=({className:a,...n})=>l.createElement("caption",{className:m("nhsuk-table__caption",a),...n}),f=({className:a,role:n="rowgroup",...o})=>l.createElement(A,{value:{head:!0}},l.createElement("thead",{className:m("nhsuk-table__head",a),role:n,...o})),E=({className:a,...n})=>l.createElement("tbody",{className:m("nhsuk-table__body",a),...n}),w=({role:a="row",variant:n,className:o,children:s,...c})=>{const{variant:r,responsiveHeadings:u,registerHeadings:T}=S(),{head:d}=P();t.useEffect(()=>{if((n==="head"||d)&&r==="responsive"){const i=[];t.Children.forEach(s,b=>{if(t.isValidElement(b)&&b.type===p){const _=b;i.push(_.props.responsiveHeading||_.props.children||"__MISSING__RESPONSIVE_HEADING__")}}),T(i)}},[s,T,d,r]);let C=s;return(n==="default"||!d)&&r==="responsive"&&(C=t.Children.map(s,(i,b)=>t.isValidElement(i)&&i.type===p?t.cloneElement(i,{__responsiveHeading:u[b]??""}):i)),l.createElement("tr",{className:m({"nhsuk-table__row":n==="default"||!d},o),role:a,...c},C)},p=({variant:a,role:n,className:o,children:s,responsiveHeading:c,__responsiveHeading:r,...u})=>{const{variant:T}=S(),{head:d}=P(),C=d?{as:"th",scope:"col",role:n||"columnheader",className:o,"data-responsive-heading":c}:{as:"td",role:n||"cell",className:m("nhsuk-table__cell",{"nhsuk-table__cell--numeric":a==="numeric"},o)};return l.createElement(V,{...C,...u},T==="responsive"&&l.createElement("span",{className:"nhsuk-table-responsive__heading"},r),s)};e.displayName="Table";g.displayName="Table.Caption";f.displayName="Table.Head";E.displayName="Table.Body";w.displayName="Table.Row";p.displayName="Table.Cell";e.Caption=g;e.Head=f;e.Body=E;e.Row=w;e.Cell=p;e.__docgenInfo={description:"",methods:[],displayName:"Table"};g.__docgenInfo={description:"",methods:[],displayName:"Table.Caption"};f.__docgenInfo={description:"",methods:[],displayName:"Table.Head",props:{role:{defaultValue:{value:"'rowgroup'",computed:!1},required:!1}}};E.__docgenInfo={description:"",methods:[],displayName:"Table.Body"};w.__docgenInfo={description:"",methods:[],displayName:"Table.Row",props:{variant:{required:!1,tsType:{name:"union",raw:"'default' | 'head'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'head'"}]},description:"@deprecated Will be removed in a future release. It now automatically detects the variant based on the context. This is now unused within the component."},role:{defaultValue:{value:"'row'",computed:!1},required:!1}}};p.__docgenInfo={description:"",methods:[],displayName:"Table.Cell",props:{variant:{required:!1,tsType:{name:"union",raw:"'default' | 'numeric'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'numeric'"}]},description:"The variant of the cell. Defaults to none."},responsiveHeading:{required:!1,tsType:{name:"string"},description:"The heading to display in when the table is in responsive mode and on small screens. If not provided, the children will be used."},__responsiveHeading:{required:!1,tsType:{name:"ReactNode"},description:"For internal use only"}}};const U={title:"Components/Content Presentation/Table",component:e,subcomponents:{"Table.Caption":e.Caption,"Table.Head":e.Head,"Table.Body":e.Body,"Table.Row":e.Row,"Table.Cell":e.Cell},argTypes:{variant:{control:!1,table:{type:{summary:"responsive | undefined"},defaultValue:{summary:"undefined"}}}},parameters:{docs:{description:{component:`Use a table to make it easier for users to compare and scan information.
