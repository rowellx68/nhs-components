import{r as l,R as e}from"./index-DCEVbkbO.js";import{c as d}from"./clsx-B-dksMZM.js";import{f as u}from"./factory-B-vprWl1.js";import{H as o}from"./Header-D5Ob_U5t.js";import{M as k}from"./Main-C6_P3jkE.js";import{H as f}from"./Heading-CC_RIS_G.js";import{C as h}from"./Container-DsMVoRsj.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Base-DkqVgamr.js";import"./polymorphic-factory-Bh8XY5CE.js";import"./VisuallyHidden-Ms4sRGqF.js";const g=()=>{const n=document.querySelector("h1"),r=document.querySelector(".nhsuk-skip-link");n&&r&&(()=>{r.addEventListener("click",t=>{t.preventDefault(),n.setAttribute("tabIndex","-1"),n.focus()}),n.addEventListener("blur",t=>{t.preventDefault(),n.removeAttribute("tabIndex")})})()},i=u(({children:n,className:r,...s},t)=>(l.useEffect(()=>{setTimeout(()=>{g()},500)}),e.createElement("a",{className:d("nhsuk-skip-link",r),href:"#maincontent",tabIndex:0,...s,ref:t},n)));i.displayName="SkipLink";i.__docgenInfo={description:"",methods:[],displayName:"SkipLink"};const I={title:"Components/Navigation/Skip Link",component:i,parameters:{layout:"fullscreen",docs:{description:{component:`Use a skip link to help keyboard-only users skip to the main content on a page.
