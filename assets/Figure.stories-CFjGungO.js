import{R as a}from"./index-uCp2LrAq.js";import{B as f}from"./Base-CQ_ipzy_.js";import{p as F}from"./polymorphic-factory-C1jPlyAy.js";import{c as m}from"./clsx-B-dksMZM.js";import{f as I}from"./factory-Dl037jXY.js";import"./_commonjsHelpers-BosuxZz1.js";const e=I(({children:s,className:t,...r},n)=>a.createElement("figure",{className:m("nhsuk-image",t),...r,ref:n},s)),p=F(({className:s,as:t="img",...r},n)=>a.createElement(f,{as:t,className:m("nhsuk-image__img",s),...r,ref:n})),c=({children:s,className:t,...r})=>a.createElement("figcaption",{className:m("nhsuk-image__caption",t),...r},s);e.displayName="Figure";p.displayName="Figure.Image";c.displayName="Figure.Caption";e.Image=p;e.Caption=c;e.__docgenInfo={description:"",methods:[],displayName:"Figure"};p.__docgenInfo={description:"",methods:[],displayName:"Figure.Image",props:{as:{required:!1,tsType:{name:"TComponent"},description:"The component to render as.",defaultValue:{value:"'img'",computed:!1}}}};c.__docgenInfo={description:"",methods:[],displayName:"Figure.Caption"};const N={title:"Components/Content Presentation/Figure",component:e,parameters:{docs:{description:{component:`Use images only if there is a real user need. Avoid unnecessary decoration.
