import{R as t}from"./index-B-o1Wr-g.js";import{c as d}from"./clsx-B-dksMZM.js";import{C as o}from"./Container-c3IPUby6.js";import"./_commonjsHelpers-Cpj98o6Y.js";const n=({className:a,...l})=>t.createElement("div",{className:d("nhsuk-u-reading-width",a),...l});n.displayName="ReadingWidth";n.__docgenInfo={description:"",methods:[],displayName:"ReadingWidth"};const p={title:"Styles/Layout/Reading Width",component:n,argTypes:{id:{control:!1,table:{type:{summary:"string"}}}},parameters:{docs:{description:{component:`To make it easy to read, lines of text should be no longer than 70 to 80 characters.
