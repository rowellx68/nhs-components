import{c as r}from"./clsx-B-dksMZM.js";import{R as t}from"./index-B-o1Wr-g.js";const e=({variant:a="grey",className:l,...n})=>t.createElement("strong",{className:r("nhsuk-tag",`nhsuk-tag--${a}`,l),...n});e.displayName="Tag";e.__docgenInfo={description:"",methods:[],displayName:"Tag",props:{variant:{required:!1,tsType:{name:"union",raw:`| 'white'
| 'grey'
| 'green'
| 'aqua-green'
| 'blue'
