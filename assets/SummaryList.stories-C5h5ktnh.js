import{R as e}from"./index-uCp2LrAq.js";import{B as h}from"./Base-CQ_ipzy_.js";import{V as p}from"./VisuallyHidden-io1tb15n.js";import{f as w}from"./factory-Dl037jXY.js";import{p as f}from"./polymorphic-factory-C1jPlyAy.js";import{c as i}from"./clsx-B-dksMZM.js";import"./_commonjsHelpers-BosuxZz1.js";const t=w(({className:n,...m},s)=>e.createElement("dl",{className:i("nhsuk-summary-list",n),...m,ref:s})),a=w(({className:n,...m},s)=>e.createElement("div",{className:i("nhsuk-summary-list__row",n),...m,ref:s})),r=({className:n,...m})=>e.createElement("dt",{className:i("nhsuk-summary-list__key",n),...m}),l=({className:n,...m})=>e.createElement("dd",{className:i("nhsuk-summary-list__value",n),...m}),u=({className:n,...m})=>e.createElement("dd",{className:i("nhsuk-summary-list__actions",n),...m}),c=f(({children:n,as:m="a",visuallyHiddenText:s,...S},L)=>e.createElement(h,{as:m,ref:L,...S},n,e.createElement(p,null," ",s)));t.displayName="SummaryList";a.displayName="SummaryList.Row";r.displayName="SummaryList.Row.Key";l.displayName="SummaryList.Row.Value";u.displayName="SummaryList.Row.Actions";c.displayName="SummaryList.Row.ActionLink";a.Key=r;a.Value=l;a.Actions=u;a.ActionLink=c;t.Row=a;t.__docgenInfo={description:"",methods:[],displayName:"SummaryList"};a.__docgenInfo={description:"",methods:[],displayName:"SummaryList.Row"};r.__docgenInfo={description:"",methods:[],displayName:"SummaryList.Row.Key"};l.__docgenInfo={description:"",methods:[],displayName:"SummaryList.Row.Value"};u.__docgenInfo={description:"",methods:[],displayName:"SummaryList.Row.Actions"};c.__docgenInfo={description:"",methods:[],displayName:"SummaryList.Row.ActionLink",props:{visuallyHiddenText:{required:!0,tsType:{name:"string"},description:""},as:{required:!1,tsType:{name:"TComponent"},description:"The component to render as.",defaultValue:{value:"'a'",computed:!1}}}};const K={title:"Components/Content Presentation/Summary List",component:t,subcomponents:{"SummaryList.Row":t.Row},parameters:{docs:{description:{component:`Use the summary list to summarise information, for example, a user's responses at the end of a form.
