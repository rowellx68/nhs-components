...
https://service-manual.nhs.uk/design-system/components/checkboxes`}}}},u={args:{label:"How would you like to be contacted?"},render:n=>e.createElement(t,{...n},e.createElement(t.Item,{value:"email"},"Email"),e.createElement(t.Item,{value:"phone"},"Phone"),e.createElement(t.Item,{value:"sms"},"Text message"))},d={args:{label:"How would you like to be contacted?",hint:"Select all options that are relevant to you."},render:n=>e.createElement(t,{...n},e.createElement(t.Item,{value:"email"},"Email"),e.createElement(t.Item,{value:"phone"},"Phone"),e.createElement(t.Item,{value:"sms"},"Text message"))},p={args:{label:"How would you like to be contacted?",error:"Select one option"},render:n=>e.createElement(t,{...n},e.createElement(t.Item,{value:"email"},"Email"),e.createElement(t.Item,{value:"phone"},"Phone"),e.createElement(t.Item,{value:"sms"},"Text message"))},x={args:{label:"What is your nationality?",hint:"If you have dual nationality, select all options that are relevant to you."},render:n=>e.createElement(t,{...n},e.createElement(t.Item,{value:"email",hint:"including English, Scottish, Welsh and Northern Irish"},"British"),e.createElement(t.Item,{value:"phone"},"Irish"),e.createElement(t.Item,{value:"sms"},"Citizen of another country"))},b={args:{label:"Do you have any of these symptoms?",hint:"Select all the symptoms you have."},render:n=>e.createElement(t,{...n},e.createElement(t.Item,{value:"sore throat",exclusiveGroup:"symptoms-list"},"Sore throat"),e.createElement(t.Item,{value:"runny nose",exclusiveGroup:"symptoms-list"},"Runny nose"),e.createElement(t.Item,{value:"muscle or joint pain",exclusiveGroup:"symptoms-list"},"Muscle or joint pain"),e.createElement(t.Divider,null),e.createElement(t.Item,{value:"none",exclusive:!0,exclusiveGroup:"symptoms-list"},"No, I do not have any of these symptoms"))},k={args:{label:"How would you like to be contacted?",hint:"Select all options that are relevant to you."},render:n=>e.createElement(t,{...n},e.createElement(t.Item,{value:"email",conditional:e.createElement(f,{label:"Email address",width:"two-thirds"})},"Email"),e.createElement(t.Item,{value:"phone",conditional:e.createElement(f,{label:"Phone number",width:"two-thirds"})},"Phone"),e.createElement(t.Item,{value:"sms",conditional:e.createElement(f,{label:"Mobile number",width:"two-thirds"})},"Text message"))};var W,H,N;u.parameters={...u.parameters,docs:{...(W=u.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
