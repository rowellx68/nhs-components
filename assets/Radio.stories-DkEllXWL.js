import{F as Q}from"./FormGroup-BW2-tT88.js";import{L as X}from"./Label-DmVPi9oB.js";import{f as B}from"./factory-DehWrhRO.js";import{u as w}from"./use-id-with-prefix-gaKPBBex.js";import{c as E}from"./clsx-B-dksMZM.js";import{r as i,R as e}from"./index-Cs7sjTYM.js";import{H as Z}from"./Hint-BOkj5kLS.js";import{a as $}from"./common-fnmo4YYw.js";import{I as N}from"./Input-B3UkT5qq.js";import"./ErrorMessage-D7s2s_-I.js";import"./VisuallyHidden-DonKESKA.js";import"./Base-fHV16vWU.js";import"./polymorphic-factory-23vJzvkj.js";import"./_commonjsHelpers-BosuxZz1.js";const J=i.createContext({withConditionals:!1,setWithConditionals:()=>{}}),ee=()=>i.useContext(J),ae=J.Provider,te=({scope:t=document}={})=>{const n=t.querySelectorAll(".nhsuk-radios--conditional .nhsuk-radios__input"),o=()=>{n.forEach(r=>$(r,"nhsuk-radios__conditional--hidden"))};"onpageshow"in window?window.addEventListener("pageshow",o):window.addEventListener("DOMContentLoaded",o),o(),n.forEach(r=>{r.addEventListener("change",o)})},a=B(({children:t,inline:n,...o},r)=>{const s=i.useRef(null);i.useImperativeHandle(r,()=>s.current);const[c,u]=i.useState(!1);i.useEffect(()=>{var d;if(!s.current)return;const l=(d=s.current.closest("form"))==null?void 0:d.parentElement;l&&te({scope:l})},[s]);const m=i.useMemo(()=>({withConditionals:c,setWithConditionals:u}),[c,u]),f=i.useMemo(()=>t,[t]);return e.createElement(ae,{value:m},e.createElement(Q,{as:"div",...o,ref:s,inputType:"radios",render:({className:l,withError:d,...h})=>e.createElement("div",{className:E("nhsuk-radios",{"nhsuk-radios--inline":n,"nhsuk-radios--conditional":c},l),...h},f)}))}),_=B(({id:t,hint:n,conditional:o,className:r,children:s,...c},u)=>{const m=!!o,{setWithConditionals:f}=ee();i.useEffect(()=>{f(m)},[]);const l=t||w("radio-item"),d=w("radio-item-hint"),h=w("radio-item-conditional");return e.createElement(e.Fragment,null,e.createElement("div",{className:"nhsuk-radios__item"},e.createElement("input",{className:E("nhsuk-radios__input",r),id:l,...c,ref:u,"aria-describedby":n?d:void 0,"aria-controls":m?h:void 0,"aria-expanded":m?"false":void 0,type:"radio"}),e.createElement(X,{htmlFor:l,className:"nhsuk-radios__label"},s),n&&e.createElement(Z,{className:"nhsuk-radios__hint",id:d},n)),m&&e.createElement("div",{className:E("nhsuk-radios__conditional nhsuk-radios__conditional--hidden"),id:h},o))}),k=({children:t="or",className:n,...o})=>e.createElement("div",{className:E("nhsuk-radios__divider",n),...o},t);a.displayName="Radio";_.displayName="Radio.Item";k.displayName="Radio.Divider";a.Item=_;a.Divider=k;a.__docgenInfo={description:"",methods:[],displayName:"Radio"};k.__docgenInfo={description:"",methods:[],displayName:"Radio.Divider",props:{children:{defaultValue:{value:"'or'",computed:!1},required:!1}}};_.__docgenInfo={description:"",methods:[],displayName:"Radio.Item"};const Ie={title:"Components/Form Elements/Radio",component:a,argTypes:{labelProps:{control:!1,table:{type:{summary:"LabelProps"}}}},args:{labelProps:{size:"l",variant:"page-heading"}},decorators:[t=>e.createElement("form",null,e.createElement(t,null))],parameters:{docs:{description:{component:`Use radios when you want users to select only 1 option from a list.
