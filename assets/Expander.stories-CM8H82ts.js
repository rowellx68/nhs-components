import{R as e}from"./index-Cs7sjTYM.js";import{D as l}from"./Details-DbA3WrxM.js";import{c as h}from"./clsx-B-dksMZM.js";import{L as g}from"./Link-3M5Wh4Hz.js";import"./_commonjsHelpers-BosuxZz1.js";import"./factory-DehWrhRO.js";import"./common-fnmo4YYw.js";import"./Base-fHV16vWU.js";import"./polymorphic-factory-23vJzvkj.js";const n=({...r})=>e.createElement(l,{...r,variant:"expander"}),o=({...r})=>e.createElement(l.Summary,{...r}),s=({...r})=>e.createElement(l.Text,{...r}),m=({children:r,className:x,...y})=>e.createElement("div",{className:h("nhsuk-expander-group",x),...y},r);n.displayName="Expander";o.displayName="Expander.Summary";s.displayName="Expander.Text";m.displayName="Expander.Group";n.Summary=o;n.Text=s;n.Group=m;n.__docgenInfo={description:"",methods:[{name:"Summary",docblock:null,modifiers:["static"],params:[{name:"{ ...props }: ExpanderSummaryProps",optional:!1,type:{name:"Omit",elements:[{name:"ComponentPropsWithoutRef",elements:[{name:"literal",value:"'summary'"}],raw:"ComponentPropsWithoutRef<TElementType>"},{name:"never"}],raw:"Omit<ComponentPropsWithoutRef<TElementType>, TPropsToOmit>",alias:"ExpanderSummaryProps"}}],returns:null},{name:"Text",docblock:null,modifiers:["static"],params:[{name:"{ ...props }: ExpanderTextProps",optional:!1,type:{name:"Omit",elements:[{name:"ComponentPropsWithoutRef",elements:[{name:"literal",value:"'div'"}],raw:"ComponentPropsWithoutRef<TElementType>"},{name:"never"}],raw:"Omit<ComponentPropsWithoutRef<TElementType>, TPropsToOmit>",alias:"ExpanderTextProps"}}],returns:null},{name:"Group",docblock:null,modifiers:["static"],params:[{name:`{
  children,
  className,
  ...props
